...
class MailSchema
{
    ...
    {
        Mail::mailer('smtp')->raw('This is a test email from OpenIRM. If you receive this, your mail configuration is working correctly.', function (Message $message) {
            $message->to(auth()->user()->email)                                
                ->subject('OpenIRM Mail Configuration Test');
        });
    }
