...
class About extends Page
{
    ...
    protected static ?string $title = 'About OpenIRM';
    ...
    {
        return 'OpenIRM is the National CII Governance & Cybersecurity Management Platform, developed under WARDIP and led by the Ministry of Communications & Digital Economy (MOCDE).
...
• Commercial use is permitted as long as resale of the OpenIRM code is not involved in any way. 
