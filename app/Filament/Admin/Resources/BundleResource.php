        ...
        return $table
                ...
                Action::make('Import')
                    ...
                    ->modalContent(function () {
                        return new HtmlString('
                                <div>This action will import the selected bundle into your OpenIRM. If you already have
                                content in OpenIRM with the same codes, this will overwrite that data.</div>');
                    })
            ...
            ->headerActions([
                Tables\Actions\Action::make('fetch')
                    ...
                    ->modalContent(function () {
                        return new HtmlString('
                                <div>This action will fetch the latest bundles from the OpenIRM repository and add them to your OpenIRM.</div>');
                    })
            ...
            ->emptyStateDescription(new HtmlString('Try fetching the latest bundles from the OpenIRM repository by clicking "Fetch Bundle Updates" above.'));
