            ...
            <div class="fi-section-content p-6">
                <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">OpenIRM</dd>
                    </div>
                    <div>
                ...
                <div class="mt-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                        OpenIRM is a cyber Governance, Risk, and Compliance (GRC) web application built for small businesses and teams. 
