<x-filament-widgets::widget>
    <x-filament::section>
        <h1 class="text-2xl font-semibold">Welcome to OpenIRM</h1>
        OpenIRM is a fast, free, lightweight, and opinionated cyber GRC tools for managing and auditing standards,
